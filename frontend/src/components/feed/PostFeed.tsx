...
const handleCommentSubmit = async (postId: number, content: string) => {
  ...
  if (loading) return <div className="text-center p-6 text-gray-500">Đang tải bài viết...</div>;
  if (error) return <div className="text-center p-6 text-red-500">{error}</div>;
  
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h2 className="text-lg font-semibold text-gray-900">Bài viết mới nhất</h2>
      </div>
