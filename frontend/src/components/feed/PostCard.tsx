    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="px-6 py-2 border-t border-gray-100">
        ...
        <div className="flex items-center justify-between border-t border-gray-100 pt-2">
          ...
          <button className="flex-1 text-center py-2 rounded-lg text-gray-600 hover:bg-gray-100 font-medium">
            Bình luận
          </button>
          <button
            onClick={onShare}
            className="flex-1 text-center py-2 rounded-lg text-gray-600 hover:bg-gray-100 font-medium"
          >
            Chia sẻ
          </button>
        </div>
